"""
H1601P scraper köprüsü — kaynak modülleri sarmalar.
"""
import logging
...
_log = logging.getLogger("cpe.h1601p")
...
def _get_device_info(driver):
    try:
        return (
            safe_find_text(driver, By.ID, "SoftwareVer",  _log, wait=3),
            safe_find_text(driver, By.ID, "HardwareVer",  _log, wait=3),
            safe_find_text(driver, By.ID, "SerialNumber", _log, wait=3),
        )
    except Exception:
        return "N/A", "N/A", "N/A"
