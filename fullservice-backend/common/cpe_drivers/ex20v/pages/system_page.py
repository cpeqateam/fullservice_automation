"""
EX20V sistem sayfasi kaziyici — uptime, RAM ve CPU degerlerini okur.

Uptime ana sayfadaki p[5]/span elementinden, RAM memFree ID'sinden,
CPU ise cpuinfo ID'sinden alinir. RAM toplam: 423064 KB (EX20V sabiti).
"""
import logging
